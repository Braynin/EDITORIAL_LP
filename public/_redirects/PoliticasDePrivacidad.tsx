        ...
        <div className={styles["politicasDePrivacidad-container"]}>
          ...
          <div className={styles["text-containerPoliticas"]}>
            <p className={styles["text-politicas"]}>
              ...
              con la protección de la privacidad y los datos personales de
              nuestros usuarios. Esta Política de Privacidad describe cómo
              recopilamos, usamos, almacenamos, protegemos y compartimos la
              información personal de los usuarios que interactúan con nuestro
              sitio web.
            </p>

            <p className={styles["text-politicas"]}>
              Te invitamos a leer esta política cuidadosamente para comprender
              nuestras prácticas en relación con tus datos personales. Al
              acceder y utilizar nuestro sitio web, aceptas los términos de esta
              política.
            </p>
            ...
            <p className={styles["text-politicas"]}>
              ...
              suscribiéndote a nuestro boletín o contactándonos, podemos
            ...
            <p className={styles["text-politicas"]}>
              Al visitar nuestro sitio, podemos recopilar automáticamente
              ciertos datos relacionados con tu uso del mismo, tales como:
            </p>
            <ul className={styles["list-politicas"]}>
              <li className={styles["li-politicas"]}>
            ...
            <p className={styles["text-politicas"]}>
              La información que recopilamos tiene diversas finalidades, entre
            ...
            <ul className={styles["list-politicas"]}>
              <li className={styles["li-politicas"]}>
                ...
                Para proporcionarte una experiencia más personalizada y
                optimizada al navegar por nuestro sitio.
              </li>
              <li className={styles["li-politicas"]}>
              ...
              <li className={styles["li-politicas"]}>
                <strong className={styles["bold"]}>
                  Seguridad y administración del sitio:
                </strong>{" "}
                Para mejorar la seguridad de nuestro sitio web y asegurarnos de
                que funcione correctamente.
              </li>
              <li className={styles["li-politicas"]}>
                <strong className={styles["bold"]}>Cumplimiento legal:</strong>{" "}
                Para cumplir con cualquier requisito legal aplicable, proteger
                nuestros derechos y resolver disputas.
              </li>
            </ul>
            ...
            <p className={styles["text-politicas"]}>
              ...
              personales con terceros para fines comerciales. Sin embargo,
            ...
            <ul className={styles["list-politicas"]}>
              <li className={styles["li-politicas"]}>
                ...
                Podemos compartir datos con proveedores de servicios externos
                que nos ayudan en la operación de nuestro sitio web.
              </li>
              <li className={styles["li-politicas"]}>
                <strong className={styles["bold"]}>
                  Cumplimiento de la ley:
                </strong>{" "}
                Podemos divulgar tus datos personales cuando sea necesario para
                cumplir con una obligación legal.
              </li>
              <li className={styles["li-politicas"]}>
                <strong className={styles["bold"]}>
                  En caso de reorganización o venta:
                </strong>{" "}
                Si Editorial LP SAC participa en una fusión, adquisición o venta
                de activos, podemos transferir tu información personal a la
                entidad adquirente.
              </li>
            </ul>
            ...
            <p className={styles["text-politicas"]}>
              ...
              Utilizamos medidas de seguridad razonables para proteger tu
              información.
            </p>
            ...
            <ul className={styles["list-politicas"]}>
              <li className={styles["li-politicas"]}>
                <strong className={styles["bold"]}>Acceso:</strong> Puedes
                solicitar una copia de los datos personales que tenemos sobre
                ti.
              </li>
              <li className={styles["li-politicas"]}>
                <strong className={styles["bold"]}>Rectificación:</strong>{" "}
                Puedes corregir cualquier dato incorrecto o desactualizado.
              </li>
              <li className={styles["li-politicas"]}>
                <strong className={styles["bold"]}>Eliminación:</strong>
                <p className={styles["text-politicas"]}>
                  Puedes solicitarnos que eliminemos tus datos personales si ya
                  no son necesarios para los fines por los que fueron recogidos.
                </p>
              </li>
              <li className={styles["li-politicas"]}>
                <strong className={styles["bold"]}>
              ...
              <li className={styles["li-politicas"]}>
                ...
                <p className={styles["text-politicas"]}>
                  Si nos has dado tu consentimiento para procesar tus datos,
                  puedes revocar ese consentimiento en cualquier momento.
                </p>
              </li>
            </ul>
          </div>
